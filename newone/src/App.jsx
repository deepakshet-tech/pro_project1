...
const PRODUCTS = [
  {
    id: 1,
    brand: "Sun Pharma",
    name: "Metformin 500mg Tablets (Strip of 10)",
    price: 42,
    mrp: 55,
    badge: "Rx",
    bc: "#0ea5e9",
  ...
  },
  {
    id: 2,
    brand: "HealthVit",
    name: "Vitamin D3 + K2 Supplement 60 Capsules",
    price: 349,
    mrp: 499,
    badge: "New",
    bc: "#059669",
    cat: "Vitamins",
    img: "https://images.unsplash.com/photo-1612532275214-e4ca76d0e4d1?w=400&q=80",
  },
  {
    id: 3,
    brand: "Cetaphil",
    name: "Moisturising Lotion Sensitive Skin 250ml",
    price: 384,
    mrp: 549,
    badge: "−30%",
    bc: "#f97316",
  ...
  },
  {
    id: 4,
    brand: "Omron",
    name: "Digital Blood Pressure Monitor HEM-7120",
    price: 1649,
    mrp: 2100,
    badge: null,
    bc: "",
  ...
  },
  {
    id: 5,
    brand: "Cipla",
    name: "Atorvastatin 10mg Film-Coated Tablets",
    price: 78,
    mrp: 95,
    badge: "Rx",
    bc: "#0ea5e9",
    cat: "Medicines",
    img: "https://www.scabpharmacy.com/wp-content/uploads/2024/01/Atorvastatin-10mg-teva-scaled.jpg",
  },
  {
    id: 6,
    brand: "Himalaya",
    name: "Neem Face Wash Purifying Gel 150ml",
    price: 139,
    mrp: 175,
    badge: null,
    bc: "",
  ...
  },
  {
    id: 7,
    brand: "Ensure",
    name: "Adult Nutrition Powder Vanilla 400g",
    price: 649,
    mrp: 799,
    badge: "Best",
    bc: "#f59e0b",
  ...
  },
  {
    id: 8,
    brand: "Dettol",
    name: "Hand Sanitizer Original 50ml Pack of 3",
    price: 119,
    mrp: 150,
    badge: null,
    bc: "",
    cat: "Personal Care",
    img: "https://www.bbassets.com/media/uploads/p/l/40193949_3-hygienix-anti-bacterial-hand-sanitizer.jpg",
  },
  {
    id: 9,
    brand: "Dr. Morepen",
    name: "Pulse Oximeter with Finger Tip Sensor",
    price: 799,
    mrp: 1299,
    badge: "−38%",
    bc: "#f97316",
    cat: "Devices",
    img: "https://m.media-amazon.com/images/I/61Q-+KR3WcL.jpg",
  },
  {
    id: 10,
    brand: "Patanjali",
    name: "Ashwagandha Churna 100g – Pure Herbs",
    price: 89,
    mrp: 120,
    badge: "Herbal",
    bc: "#65a30d",
    cat: "Ayurveda",
    img: "https://images.unsplash.com/photo-1607619662634-3ac55ec0e216?w=400&q=80",
  },
  {
    id: 11,
    brand: "MuscleBlaze",
    name: "Whey Protein Isolate Chocolate 1kg",
    price: 1899,
    mrp: 2499,
    badge: "Hot",
    bc: "#ef4444",
    cat: "Nutrition",
    img: "https://images.jdmagicbox.com/quickquotes/images_main/knox-hand-sanitizer-30-03-2021-148-226793204-032vr.jpg",
  },
  {
    id: 12,
    brand: "Pampers",
    name: "Baby Dry Diapers Size M (7–12 kg) 56pcs",
    price: 849,
    mrp: 1099,
    badge: "New",
    bc: "#059669",
...
const PACKAGES = [
  {
    ...
    tagline: "75 tests · All-in-one wellness",
    price: 999,
    mrp: 2800,
    popular: true,
    img: "https://www.jeewanmalahospital.com/img/hospital.jpg",
    tests: [
  ...
  },
  {
    ...
    tagline: "28 tests · Heart health",
    price: 799,
    mrp: 1900,
    popular: false,
    img: "https://images.unsplash.com/photo-1559757175-0eb30cd8c063?w=500&q=80",
    tests: [
      "Lipid Profile Full",
      "hs-CRP",
      "Homocysteine",
  ...
  },
  {
    ...
    tagline: "42 tests · Hormonal health",
    price: 1249,
    mrp: 3200,
    popular: false,
  ...
  },
  {
    ...
    tagline: "18 tests · Blood sugar",
    price: 599,
    mrp: 1400,
    popular: false,
    img: "https://images.unsplash.com/photo-1579154204601-01588f351e67?w=500&q=80",
    tests: [
  ...
  },
  {
    ...
    tagline: "65 tests · Age-focused",
    price: 1499,
    mrp: 4000,
    popular: false,
    img: "https://images.unsplash.com/photo-1582719471384-894fbb16e074?w=500&q=80",
    tests: [
  ...
  },
  {
    ...
    tagline: "12 tests · Quick snapshot",
    price: 249,
    mrp: 700,
    popular: false,
...
const BLOGS = [
  {
    ...
    tagColor: "#991b1b",
    tagBg: "#fee2e2",
    title: "5 Foods Cardiologists Want You to Eat Every Week",
    excerpt:
      "Heart-protective foods that reduce inflammation and support arterial health.",
  ...
  },
  {
    ...
    excerpt:
      "Temperature, humidity and light all affect drug potency. Keep medicines effective.",
    author: "PharmD. Rahul Nair",
    time: "3 min",
  },
  {
    ...
    excerpt:
      "Evidence-based nutritional strategies and workout plans from endocrinologists.",
    author: "Dr. Anita Bose",
    time: "7 min",
  },
  {
    ...
    tagColor: "#075985",
    tagBg: "#e0f2fe",
    title: "Sleep Hygiene: Why 7 Hours Changes Everything",
    excerpt:
      "Practical tips to fix your sleep cycle for better immunity, mood and cognition.",
    author: "Dr. Suresh Menon",
    time: "6 min",
  },
  {
    img: "https://images.unsplash.com/photo-1607619662634-3ac55ec0e216?w=600&q=80",
    tag: "Nutrition",
    tagColor: "#581c87",
    tagBg: "#f3e8ff",
    title: "Vitamin D Deficiency: The Silent Epidemic in India",
    excerpt:
      "Over 70% of Indians are deficient in Vitamin D. How to test and supplement safely.",
    author: "PharmD. Divya Rao",
    time: "4 min",
  },
  {
    ...
    tagColor: "#9a3412",
    tagBg: "#ffedd5",
    title: "The Right Protein Supplement: Whey, Plant or Collagen?",
    excerpt:
      "A pharmacist's honest guide to choosing the right protein powder for your goals.",
    author: "PharmD. Rahul Nair",
    time: "8 min",
  },
];
...
const CATEGORIES = [
  ...
  },
  {
    ...
    bg: "#fffbeb",
    border: "#fde68a",
    img: "https://images.unsplash.com/photo-1612532275214-e4ca76d0e4d1?w=200&q=80",
  },
  {
    name: "Skincare",
    count: "4,200+",
  ...
  },
  {
    ...
    bg: "#f0f9ff",
    border: "#bae6fd",
    img: "https://images.unsplash.com/photo-1576671081837-49000212a370?w=200&q=80",
  },
  {
    name: "Baby Care",
    count: "1,900+",
    bg: "#faf5ff",
    border: "#e9d5ff",
    img: "https://images.unsplash.com/photo-1515488042361-ee00e0ddd4e4?w=200&q=80",
  },
  {
    name: "Nutrition",
    count: "3,100+",
  ...
  },
  {
    ...
    bg: "#f7fee7",
    border: "#d9f99d",
    img: "https://images.unsplash.com/photo-1607619662634-3ac55ec0e216?w=200&q=80",
  },
  {
    name: "Lab Tests",
    count: "240+",
    bg: "#f0fdfa",
    border: "#99f6e4",
    img: "https://images.unsplash.com/photo-1581093458791-9d09c4a3b9f0?w=200&q=80",
  },
];

const STORES = [
  {
    name: "MediCare+ Koramangala",
    addr: "80 Feet Rd, Koramangala 4th Block, Bengaluru",
    dist: "0.8 km",
  },
  {
    name: "MediCare+ Indiranagar",
    addr: "100 Feet Rd, HAL 2nd Stage, Indiranagar",
    dist: "2.1 km",
  },
  {
    name: "MediCare+ HSR Layout",
    addr: "Sector 1, HSR Layout, Bengaluru 560102",
    dist: "3.4 km",
  },
  {
    name: "MediCare+ Whitefield",
    addr: "ITPL Main Rd, Whitefield, Bengaluru",
    dist: "8.7 km",
  },
];
...
function AccountModal({ onClose }) {
  ...
  return (
    <Overlay onClose={onClose}>
      <div
        className="modal-anim modal-inner"
        style={{
          width: 400,
          background: "#fff",
          borderRadius: 20,
      ...
      >
        ...
        <div style={{ padding: "48px 32px", textAlign: "center" }}>
          ...
          <div style={{ color: "#9ca3af", fontSize: 13, marginBottom: 24 }}>
            Sign in to save and sync your favourite items across devices.
          </div>
          <button
            onClick={onClose}
            style={{
...
function PackageBookModal({ pkg, onClose, showToast }) {
  ...
  const handleConfirm = () => {
    if (!name || !phone || !date || !slot) {
      showToast("⚠️ Please fill all fields to book!");
      return;
    }
    onClose();
    showToast(`✅ ${pkg.name} booked for ${date}!`);
  };
  return (
    <Overlay onClose={onClose}>
      <div
        className="modal-anim modal-inner-wide"
        style={{
          width: 460,
          background: "#fff",
          borderRadius: 20,
...
function CartPanel({ items, onClose, onQty, onRemove, onConfirm, confirmed }) {
  ...
  return (
    <Overlay onClose={onClose} side>
      <div
        className="cart-slide cart-panel-inner"
        style={{
          width: 400,
          background: "#fff",
          display: "flex",
      ...
      >
        ...
        {confirmed ? (
          ...
          >
            ...
            >
              Thank you for shopping with <strong>MediCare+</strong>.
            </p>
            <p
              style={{
                color: "#6b7280",
            ...
            >
              Your order will be delivered by <strong>Tomorrow, 6 PM</strong>.
            </p>
            <div
              style={{
                background: "#f0fdf4",
          ...
          <>
                      ...
                      >
                        <button
                          ...
                          style={{
                            ...
                            background: "none",
                            cursor: "pointer",
                            fontSize: item.qty === 1 ? 14 : 18,
                            fontWeight: 700,
                            color: item.qty === 1 ? "#ef4444" : "#059669",
                            display: "grid",
                            placeItems: "center",
                          }}
                        >
            ...
            >
              ...
              >
                🎉 You save ₹{saved.toLocaleString()} on this order!
              </div>
              <button
                onClick={onConfirm}
                style={{
    ...
    >
      ...
      >
        <span style={{ color: "#fff", fontSize: 12 }}>
          📞 Pharmacist Helpline: <strong>1800-103-0123</strong> · 24/7
          Toll-free
        </span>
      ...
      >
        ...
        >
          ...
          >
            MediCare<span style={{ color: "#f59e0b" }}>+</span>
          </span>
        </button>
        ...
        <div ref={searchRef} style={{ position: "relative" }}>
          ...
          >
            ...
            <input
              ...
              onFocus={() => {
                if (search.trim()) setShowDrop(true);
              }}
          ...
          {showDrop && suggestions.length > 0 && (
            ...
            >
              ...
              <div
                style={{ padding: "10px 16px", borderTop: "1px solid #f3f4f6" }}
              >
                <button
                  onClick={handleGo}
                  style={{
          ...
          {showDrop && search.trim().length > 0 && suggestions.length === 0 && (
            ...
            >
              <div style={{ fontSize: 13, color: "#9ca3af" }}>
                ...
                <strong style={{ color: "#111827" }}>{search}</strong>" in{" "}
                <strong>{searchCat}</strong>
              </div>
              <button
                onClick={handleGo}
                style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
          ...
          >
            📋 <span className="rx-btn-text">Upload Rx</span>
          </button>
        </div>
      </div>
  ...
  return (
    ...
    >
      <div>
        ...
        {sub && (
          <p style={{ fontSize: 13, color: "#9ca3af", marginTop: 5 }}>{sub}</p>
        )}
      </div>
      {cta && (
        <button
...
export function HomePage({ setPage, addToCart }) {
  ...
  const banners = [
    {
      ...
      sub: "Genuine medicines · Expert pharmacists · Fast delivery.",
      cta: "Shop Now",
      p: "products",
    },
    {
      ...
      label: "UP TO 40% OFF",
      title: "Lab Tests at\nHome Collection",
      sub: "Book health checkup packages with doorstep sample collection.",
      cta: "Book Test",
      p: "packages",
    },
    {
      ...
      title: "Vitamins &\nSupplements Sale",
      sub: "Top brands on vitamins, proteins and nutrition products.",
      cta: "Explore",
      p: "products",
    },
  ];
  ...
  return (
    <div style={{ background: "#f3f4f6" }}>
      ...
      <div
        style={{ maxWidth: 1180, margin: "0 auto", padding: "48px 32px 56px" }}
      >
        <div
          style={{
        ...
        >
          <div style={{ display: "flex", alignItems: "center", gap: 18 }}>
            ...
            <div>
              ...
              >
                Have a Prescription? Get Medicines in 2 Hours!
              </div>
              <div style={{ color: "rgba(255,255,255,0.85)", fontSize: 13 }}>
                Our pharmacists verify and dispatch your medicines fast.
              </div>
            </div>
          </div>
          <button
        ...
        <SHead
          ...
          sub="Everything you need for your health & wellness"
          cta="View All"
          onCta={() => setPage("products")}
        />
        <div
        ...
        >
          {CATEGORIES.map((c) => (
            <button
              key={c.name}
              onClick={() =>
                setPage(c.name === "Lab Tests" ? "packages" : "products")
              }
              style={{
                background: c.bg,
        ...
        <SHead
          ...
          sub="Most trusted by our customers"
          cta="View All"
          onCta={() => setPage("products")}
        />
        <div
        ...
        >
          {PRODUCTS.slice(0, 8).map((p) => (
            <PCard key={p.id} p={p} setPage={setPage} addToCart={addToCart} />
          ))}
        </div>
        <div
          style={{
        ...
        >
          <div>
            ...
            >
              Comprehensive packages starting at ₹249. Home sample collection.
            </p>
          </div>
          <button
        ...
        <SHead
          ...
          sub="Expert advice from our pharmacists"
          cta="Read All"
          onCta={() => setPage("blog")}
        />
        <div
...
export function ProductsPage({ setPage, addToCart }) {
  ...
  return (
    <div style={{ background: "#f3f4f6" }}>
      <div
        style={{ maxWidth: 1180, margin: "0 auto", padding: "40px 32px 56px" }}
      >
        <div className="products-layout" style={{ display: "flex", gap: 28 }}>
          ...
          >
            <div
              className="products-sidebar-inner"
              style={{
                background: "#fff",
                border: "1.5px solid #e5e7eb",
                borderRadius: 16,
                  ...
                  >
                    <span
                      style={{
                        ...
                        borderRadius: 4,
                        background: cat === c ? "#059669" : "transparent",
                        flexShrink: 0,
                        display: "grid",
                        placeItems: "center",
                      }}
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {cats.map((c) => (
                <button
                  ...
                  style={{
                    ...
                    fontWeight: 600,
                    cursor: "pointer",
                    border: `1.5px solid ${cat === c ? "#059669" : "#e5e7eb"}`,
                    background: cat === c ? "#059669" : "#fff",
            ...
            >
              <span style={{ fontSize: 13, color: "#6b7280" }}>
                <strong style={{ color: "#111827" }}>{shown.length}</strong>{" "}
                products found
              </span>
              <select
                value={sort}
    ...
    <div style={{ background: "#f3f4f6" }}>
      ...
      >
        ...
        >
          ...
          <span>/</span>
          <span style={{ color: "#374151" }} className="lc2">
            {p.name}
          </span>
        </div>
        <div
              ...
              {PRODUCTS.slice(0, 5).map((prod, i) => (
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 10,
                    overflow: "hidden",
                    border: `2px solid ${sel === i ? "#059669" : "#e5e7eb"}`,
                    flexShrink: 0,
                    padding: 0,
                    cursor: "pointer",
                  }}
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  Free Delivery by Tomorrow, 6 PM
                </div>
                <div style={{ fontSize: 12, color: "#9ca3af", marginTop: 3 }}>
                  Express 2-hour delivery available for ₹49
                </div>
              </div>
            </div>
          </div>
...
export function RxPage({ showToast }) {
  ...
  return (
    <div style={{ background: "#f3f4f6" }}>
      <div
        style={{ maxWidth: 680, margin: "0 auto", padding: "56px 32px 64px" }}
      >
        <div style={{ textAlign: "center", marginBottom: 40 }}>
          ...
          >
            Our certified pharmacists will verify your prescription and prepare
        ...
        <div
          ...
          style={{
            border: `2px dashed ${drag ? "#059669" : "#6ee7b7"}`,
            borderRadius: 18,
            padding: "60px 32px",
            textAlign: "center",
            cursor: "pointer",
        ...
        >
          {[
            ...
            [
              "👨‍⚕️",
              "Expert Review",
              "Certified pharmacists review every prescription.",
            ],
            [
              "⚡",
              "Fast Processing",
              "Verified within 30 minutes during pharmacy hours.",
            ],
            [
              "📦",
              "Quick Delivery",
              "Medicines delivered within 2–4 hours of approval.",
            ],
          ].map(([icon, title, text]) => (
            <div
              key={title}
        ...
        <button
          onClick={() => {
            if (!file) {
              showToast("⚠️ Please upload a prescription first!");
              return;
            }
            showToast("✅ Submitted! Pharmacist will review shortly.");
          }}
          style={{
            width: "100%",
            marginTop: 32,
    ...
    <div style={{ background: "#f3f4f6" }}>
      ...
      >
        ...
        >
          ...
          >
            Comprehensive lab test packages designed by expert physicians.
            <br />
            Home collection · Results in 24–48 hours.
          </p>
        </div>
        <div
          ...
          {tabs.map((t) => (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                cursor: "pointer",
                border: `1.5px solid ${active === t ? "#059669" : "#e5e7eb"}`,
                background: active === t ? "#059669" : "#fff",
                color: active === t ? "#fff" : "#4b5563",
              }}
            >
              {t}
            </button>
        ...
        >
          {PACKAGES.map((pkg) => (
            <div
              ...
              style={{
                background: "#fff",
                border: `1.5px solid ${pkg.popular ? "#059669" : "#e5e7eb"}`,
                borderRadius: 18,
                overflow: "hidden",
              }}
            >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    inset: 0,
                    background:
                      "linear-gradient(to top,rgba(6,78,59,0.7),transparent)",
                  }}
                />
                {pkg.popular && (
                  <span
              ...
              <div style={{ padding: "22px 22px" }}>
                ...
                <div
                  style={{ color: "#9ca3af", fontSize: 13, marginBottom: 16 }}
                >
                  {pkg.tagline}
                </div>
                <div
...
export function BlogPage() {
  ...
  const filtered =
    active === "All" ? BLOGS : BLOGS.filter((b) => b.tag === active);
  return (
    <div style={{ background: "#f3f4f6" }}>
      <div
        style={{ maxWidth: 1180, margin: "0 auto", padding: "40px 32px 56px" }}
      >
        ...
        >
          <img
            src="https://images.unsplash.com/photo-1505751172876-fa1923c5c528?w=1200&q=50"
            alt=""
            style={{
              position: "absolute",
              inset: 0,
          ...
          />
          <div
            style={{ position: "relative", zIndex: 1, padding: "52px 48px" }}
          >
            <span
              style={{
                display: "inline-block",
            ...
            >
              The Complete Guide to Managing Hypertension Naturally in 2025
            </h2>
            <p
              style={{
                color: "rgba(255,255,255,0.7)",
            ...
            >
              Hypertension affects 1 in 3 adults. Our chief pharmacist walks
              through evidence-based lifestyle interventions.
            </p>
            <button
              style={{
                background: "#059669",
            ...
            {filters.map((f) => (
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  cursor: "pointer",
                  border: `1.5px solid ${active === f ? "#059669" : "#e5e7eb"}`,
                  background: active === f ? "#059669" : "#fff",
...
export function ContactPage({ showToast }) {
  ...
  return (
    <div style={{ background: "#f3f4f6" }}>
      <div
        style={{ maxWidth: 1100, margin: "0 auto", padding: "48px 32px 64px" }}
      >
        <div style={{ textAlign: "center", marginBottom: 48 }}>
          ...
          >
            Speak to our certified pharmacists, find your nearest store, or send
            us a message.
          </p>
        </div>
        <div
        ...
        >
          <div>
            ...
            >
              ...
              <div style={{ fontSize: 13, opacity: 0.82, marginBottom: 18 }}>
                Toll-free · Available 24/7
              </div>
              <button
                onClick={() => showToast("📞 Calling helpline...")}
                style={{
                  background: "rgba(255,255,255,0.2)",
                  border: "1px solid rgba(255,255,255,0.3)",
                  color: "#fff",
            ...
            {[
              ["📧", "Email", "care@medicare-plus.in"],
              ["💬", "WhatsApp", "+91 98765 43210"],
              ["🕐", "Hours", "Mon–Sat, 8 AM – 10 PM"],
            ].map(([icon, label, val]) => (
              <button
                key={label}
                onClick={() => showToast(`${icon} ${val}`)}
                style={{
                  display: "flex",
                  alignItems: "center",
                  gap: 16,
          ...
          >
            ...
            >
              {[
                ["First Name", "first", "Ravi"],
                ["Last Name", "last", "Kumar"],
              ].map(([l, k, ph]) => (
                <div key={k}>
            ...
            {[
              ["Email Address", "email", "ravi@example.com", "email"],
            ...
            <button
              onClick={() => {
                if (!form.email || !form.message) {
                  showToast("⚠️ Please fill email and message!");
                  return;
                }
...
function Footer({ setPage }) {
  return (
    <footer style={{ background: "#111827", color: "rgba(255,255,255,0.55)" }}>
        ...
        >
          <div>
            ...
            >
              ...
              >
                MediCare<span style={{ color: "#fbbf24" }}>+</span>
              </span>
            </button>
            <p
              style={{
      ...
      >
        <p style={{ fontSize: 12 }}>
          © 2025 MediCare+ Pharmacy. All rights reserved. Lic. No.
          MH/DRUGS/123/2018
        </p>
        <div className="footer-badges" style={{ display: "flex", gap: 8 }}>
          {["🔒 SSL Secure", "✚ CDSCO Certified", "🏥 ISO 9001"].map((b) => (
            <span
              key={b}
              style={{
    ...
    <>
      ...
      */}
      ...
      >
        ...
        {wishlistOpen && (
          <WishlistModal onClose={() => setWishlistOpen(false)} />
        )}
        {bookingPkg && (
          <PackageBookModal
            pkg={bookingPkg}
